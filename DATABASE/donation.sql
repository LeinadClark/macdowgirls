...
('21e2117b-7479-4f1b-8c9c-c9c26f7a86fc', '34808752-3634-11f1-8bf3-40c2bae4b8c0', '476860d3-0a04-4742-a985-56e8849ca9e1', 1000.00, 'TXN-AFBEF82B', 'success', 0, 'GCash', '2026-04-12 07:04:37'),
('79bfadeb-c6cd-4dc5-b1e1-ab4ee729a47c', '348048fc-3634-11f1-8bf3-40c2bae4b8c0', '476860d3-0a04-4742-a985-56e8849ca9e1', 1000.00, 'TXN-A62580FB', 'success', 0, 'GCash', '2026-04-12 07:56:28');
...
-- --------------------------------------------------------
-- Table structure for table `campaign_suggestions` (NEW)
-- --------------------------------------------------------
...
ALTER TABLE `campaign_suggestions`
  ADD CONSTRAINT `campaign_suggestions_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE SET NULL;
